...
var (
	...
	ColorSectionCardBg = color.NRGBA{R: 250, G: 250, B: 252, A: 255}
	...
	// Card drop shadow layers (subtle depth cue).
	ColorCardShadow1 = color.NRGBA{A: 12}
	ColorCardShadow2 = color.NRGBA{A: 8}
